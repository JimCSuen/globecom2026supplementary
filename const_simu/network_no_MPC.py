...
class ServiceSatNetDelta(SatNet):
    ...
    def vectorized_history_update(self):
        ...
        # * MPC link LB
        # print(f"check point for final_route_decision: {self.vectorized_auxiliary[
        #             :,
        #             0 : self.N_max
        #             * self.constellation.num_sats
        #             * self.constellation.num_sats,
        #         ].value, 1 / self.vectorized_full_link_bw_mat}, ")
        ...
        # print(f"check point for lyap_MPC_link_LB: {link_load_ratio_mat}, lyap_MPC_MLLR: {lyap_MPC_MLLR}")
    ...
    def do_rand_bw_alloc(self):
        ...
        for key, val in self.rand_task_alloc.items():
            ...
            src_sat = (int(task_description[0] + 1), int(task_description[1] + 1))
